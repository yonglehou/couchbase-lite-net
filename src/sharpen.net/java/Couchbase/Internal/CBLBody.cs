...
namespace Couchbase.Internal
{
	...
	public class CBLBody
	{
		...
		public static Couchbase.Internal.CBLBody BodyWithProperties(IDictionary<string, object
			> properties)
		{
			Couchbase.Internal.CBLBody result = new Couchbase.Internal.CBLBody(properties);
			return result;
		}

		public static Couchbase.Internal.CBLBody BodyWithJSON(byte[] json)
		{
			Couchbase.Internal.CBLBody result = new Couchbase.Internal.CBLBody(json);
			return result;
		}
