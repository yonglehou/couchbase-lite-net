...
namespace Couchbase
{
	/// <summary>Lets you stream a large attachment to a CBLBlobStore asynchronously, e.g.
	/// 	</summary>
	/// <remarks>Lets you stream a large attachment to a CBLBlobStore asynchronously, e.g. from a network download.
	/// 	</remarks>
